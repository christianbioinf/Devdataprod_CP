...
input <- data.frame(measure = "sens", dataset = "Illumina (artificial)", stringsAsFactors=F)
h <- myPlot(input, data)
h$save('fig/h.html', cdn = TRUE)
cat('<iframe src="fig/h.html" width=100%, height=500></iframe>')
```
